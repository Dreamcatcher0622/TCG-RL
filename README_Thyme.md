...
<img src="asset/keye_logo.png"  width="50%" height="50%">
</p>
...
<img src="asset/pipeline.png"  width="100%" height="100%">
</p>
...
> **Note (this release).** The vendored `eval/VLMEvalKit/` copy and the upstream ms-swift
> documentation have been removed to keep this repository small. Install VLMEvalKit from
> its upstream repository instead:
>
> ```shell
...
```shell
# or use the ms-swift eval backend, which pulls it in via pip:
pip install "evalscope[vlmeval]"
```

### 5.2 Evaluate on Multiple Benchmarks
    
For example, to evaluate on `V*` and `HRBench` with 8 GPUs, run inside your VLMEvalKit checkout:
```shell
