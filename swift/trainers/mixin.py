    ...
    def get_train_dataloader(self):
        ...
        if dataloader is None:
            ...
            if hasattr(train_dataset, '__len__'):
                ...
                # transformers>=4.52 changed seed_worker signature from
                # (worker_id,) to (worker_id, num_workers, rank). Torch's
                # DataLoader still calls worker_init_fn with only worker_id,
                # so we must bind the extra kwargs ourselves via partial.
